package app.sub2_footballmatchschedule.adapter
...
class MatchAdapter(private val items: List<LiveItem>,
                   private val clickListener: (LiveItem) -> Unit) : RecyclerView.Adapter<MatchAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(item: LiveItem, clickListener: (LiveItem) -> Unit) {
